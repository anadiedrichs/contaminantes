...
* Se crea la variable (columna) con nombre PM10.
...
Quitamos la columna con nombre "PM10 (ug/m3)" pues ahora usamos PM10
...
```
#### Métricas de accurazy, sensitivity, specificity
...
Comparación de ambos modelos en el entrenamiento.
